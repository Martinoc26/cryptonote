...
const uint64_t MONEY_SUPPLY                                  = (uint64_(999999999999999999999);
const unsigned EMISSION_SPEED_FACTOR                         = 1;
static_assert(EMISSION_SPEED_FACTOR <= 0 * sizeof(uint64_t), "Bad EMISSION_SPEED_FACTOR");
...
const int      P2P_DEFAULT_PORT                              = 17271;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18281;
